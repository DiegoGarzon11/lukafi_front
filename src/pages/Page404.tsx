			...
			<div className='flex justify-between items-center w-3/4 '>
				<div
					...
					<img
						...
						className='relative w-full pl-10 row-span-2 pt-10 scale-100 transform transition-transform duration-500 hover:rotate-3 z-20 group-hover:scale-110'
					/>
				</div>

				<div className='flex flex-col items-end'>
					<p className='text-end font-semibold dark:text-white text-9xl'>Oops!</p>
					<p className='dark:text-white text-2xl text-balance my-10 text-end'>

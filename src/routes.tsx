...
const RoutesManager = () => (
	<Routes>
		...
		<Route
			...
			element={isAuthenticated ? <SeeExpenses /> : <Navigate to='/auth' />}
		/>
		<Route
			path='/wallet/debts'
			element={isAuthenticated ? <SeeDebts /> : <Navigate to='/auth' />}
		/>
		<Route
			path='/wallet/incomes'
			element={isAuthenticated ? <SeeIncomes /> : <Navigate to='/auth' />}
		/>
		<Route
			path='/profile'
		...
		<Route
			...
			element={isAuthenticated ? <DeleteAccount /> : <Navigate to='/auth' />}
		/>
		<Route
			path='/restore-account'
			element={isAuthenticated ? <RestoreAccountPage /> : <Navigate to='/auth' />}
		/>
		<Route

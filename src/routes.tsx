...
const RoutesManager = () => (
	<Routes>
		<Route element={userDeleted != null ? <RestoreAccountPage /> : ''}>
			...
			<Route path='auth' element={isAuthenticated ? <Navigate to='/dashboard' /> : <Home />} />
			<Route path='dashboard' element={isAuthenticated ? <Dashboard /> : <Navigate to='/' />} />

			<Route path='/wallet/expenses' element={isAuthenticated ? <SeeExpenses /> : <Navigate to='/' />} />
			<Route path='/wallet/debts' element={isAuthenticated ? <SeeDebts /> : <Navigate to='/' />} />
			<Route path='/wallet/incomes' element={isAuthenticated ? <SeeIncomes /> : <Navigate to='/' />} />
			<Route path='/profile' element={isAuthenticated ? <Profile /> : <Navigate to='/' />} />
			<Route path='/auth/delete-account' element={isAuthenticated ? <DeleteAccount /> : <Navigate to='/' />} />

			<Route path='/auth/restore-password' element={isAuthenticated ? <Dashboard /> : <ForgetPassword />} />
			<Route path='/auth/change-password' element={isAuthenticated ? <ForgetPassword /> : <Navigate to='/' />} />
